    ...
    ExportDeclaration(path) {
      ...
      if (declarationName) {
        ...
        if (declaration.type === 'FunctionDeclaration') {
          console.log(require('util').inspect(declaration, { depth: 2 }));
      ...
      //   this.export = t.identifier(className)
      //   path.replaceWith(declaration)
      // }
      // else if (declaration.type === 'FunctionDeclaration') {
      //   const funcName =
      //   if (funcName) {
      //     this.export = t.identifier(funcName)
      //     path.replaceWith(declaration)
      //     return
      //   }
      //   console.log("declaration:", declaration.type);
      //   console.log(require('util').inspect(declaration, { depth: 2 }));
      // }
      // else {
      //   // Should be Identifier or ObjectExpression
      //
      ...
      //   this.export = path.node.declaration
      //   path.remove()
      // }
    },
