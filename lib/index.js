...
exports.default = function (_ref) {
        ...
        Program: {
            enter: function enter(path) {
                ...
                if (filePath.startsWith(sourceRootPath)) {
                    ...
                    relativeFilePathWithoutExtension = _path2.default.dirname(relativeFilePath) + "/" + _path2.default.basename(relativeFilePath, _path2.default.extname(relativeFilePath));
    ...
    function getSourceRoot() {
        ...
        if (path.hub.file.opts.sourceRoot) {
            ...
            sourceRootPath = _path2.default.resolve("./");
        }
