...
import { getIdName, getOtherPropertiesOfIdentifier, groupPropertiesByName, isImport } from './helpers/ast'
    ...
    Class: {
      enter(path, { opts = {} }) {
        ...
        if (doesClassExtendFromImport(node, [...this.imports, ...this.requires])) {
          ...
          const ui5ExtendClass = convertClassToUI5Extend(path, node, classInfo, staticProps, opts)
