 ...
 */
export function convertClassToUI5Extend(node, classInfo, extraStaticProps, opts) { // eslint-disable-line no-unused-vars
  ...
  const isController = opts.moveControllerPropsToOnInit && className.includes('Controller') || !!classInfo.controller
